...
struct EntryPoint: App {
    ...
    */
    ...
    private var secondaryWindows: some SwiftUI.Scene {
        ...
        .environmentObject(notebookManager)                                       // ADD
        .environment(\.generateNotebookJSON, { makeNotebookJSON(from: windowManager) }) // ADD
...
struct ProjectAwareEnvironmentView: View {
    ...
    var body: some View {
        ...
        EnvironmentView()
            .environmentObject(notebookManager) // for juypterkit
